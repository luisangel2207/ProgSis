...
class Instruccion 
{
	...
	public void crearArbolDeEtqs(TreeMap<String,String> arbolDeEtq,Archivo ArcTds)
	{
		String linea;
		ArcTds.crearBuffer();
		while((linea = ArcTds.lineaActual()) != null) //mientras existan lineas en el Tds
		{
			StringTokenizer st = new StringTokenizer(linea);

			String etq = st.nextToken(); //campo Etiqueta
			String valor = st.nextToken(); //campo Valor
			arbolDeEtq.put(etq, valor); //ingresamos en el Arbol estos valores
		}
	}
